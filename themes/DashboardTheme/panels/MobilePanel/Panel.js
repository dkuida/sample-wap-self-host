  ...
  return declare([_WidgetBase, _TemplatedMixin, Evented], {
    ...
    onMoving: function(mover){
      ...
      if (this.mobileLayout === PORTRAIT_MODE) { // Move horizontally
        ...
        // Move horizontally
        domStyle.set(this.widgetContainerNode, 'left', (this._moveStartX + dx +
          SPLITTER_HEIGHT) + 'px');
        domStyle.set(this.splitterNode, 'left', (this._moveStartX + dx) + 'px');
        domStyle.set(this.splitterNode, 'top', '0');
      }
    },
    ...
    _resizeWidgetHorizontally: function(dx) {
      ...
      var splitterLeft, mapLeft, mapWidth, widgetWidth;
